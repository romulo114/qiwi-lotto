...
export const signUp = async ({
  ...
  return await authPost(`${BASE_URL}/signup`, SEC_TOKEN, body);
};

export const login = async (email, password) => {
  return await authPost(`${BASE_URL}/login`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    Email: email,
    Password: password,
  });
...
export const getMoneyBalance = async (memberID) => {
  return await authPost(`${BASE_URL}/get-member-money-balance`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
  });
};
...
export const updatePersonalDetails = async (
  ...
  return await authPost(`${BASE_URL}/update-personal-details`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
    Email: email,
    FirstName: firstName,
...
export const updatePassword = async (email, password, memberID) => {
  return await authPost(`${BASE_URL}/update-password`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
    Email: email,
    Password: password,
...
export const getTransactionsByID = async (page, pageSize, memberID) => {
  return await authPost(`${BASE_URL}/get-transactions-by-memberid`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
    PageNumber: page,
    PageSize: pageSize,
...
export const updateCreditCard = async (
  ...
  return await authPost(`${BASE_URL}/add-update-credit-card`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
    ID: payID,
    CardType: cardType,
...
export const deleteCreditCard = async (payID, memberID) => {
  return await authPost(`${BASE_URL}/update-credit-card`, SEC_TOKEN, {
    BrandID: BRAND_ID,
    MemberID: memberID,
    ID: payID,
    IsActive: false,
