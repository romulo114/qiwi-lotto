          ...
          <div id="middle" className="lotterydetail">
            <div className="flex-container">
              <div className="how-to-play">
                ...
                <div className="step">
                  ...
                  <div className="text" id="how-to-play-label-step1">
                    Choose your numbers or QuickPick
                  </div>
            ...
            <div className={`beton-header ${data.LotteryName}`}>
              <div className="beton-header-mobile-section">
                <div className="lotto-name-container">
                  <img
                    src={`/images/logos/${lotto}1.png`}
                    className="lotto-logo"
                  />
                ...
                <div className="lotto-timer">
                  <div className="timer-view">
                    {curTime.tm < 0 && (
                      <div className="item-expired">EXPIRED</div>
                    )}
                    {curTime.tm >= 0 && (
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <div className="timer-value timer-value-days value-days">
                                {curTime.days}
                              </div>
                            </td>
                            <td>
                              <div className="timer-delimiter">:</div>
                            </td>
                            <td>
                              <div className="timer-value timer-value-hours value-hours">
                            ...
                            <td>
                              <div className="timer-value timer-value-minutes value-minutes">
                            ...
                            <td>
                              <div className="timer-value timer-value-seconds value-seconds">
                          ...
                          <tr>
                            <td>
                              <div className="timer-unit unit-0">days</div>
                            </td>
                            <td></td>
                            <td>
                              <div className="timer-unit unit-1">hrs</div>
                            </td>
                            <td></td>
                            <td>
                              <div className="timer-unit unit-2">min</div>
                            </td>
                            <td></td>
                            <td>
                              <div className="timer-unit unit-3">sec</div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
            ...
            <div className="select_page_det left">
              ...
              <div className="select_page_det2">
                <div className="del_cup">
                  <img src="/images/del_cup.png" />
                </div>
                <div className="star">
...
export async function getStaticProps(context) {
  ...
  try {
    ...
    const lottery = draws.find(
      (item) => item.LotteryName.replace(/ /g, "").toLowerCase() === lotto
    );

    const rules = result[1];
    const rule = rules.find(
      (item) => item.LotteryTypeId == lottery.LotteryTypeId
    );
    if (!rule) {
      return { props: {} };
    }
    ...
    const options = rule.ProductsDrawOptions.find(
      (option) => option.ProductId === 1 && !option.IsSubscription
    );
