            ...
            <div className="comman">
              <div className="thankyoupage1">
                <p className="thanktxt1">
                  Congratulation, your payment was successful. We wish you luck
                  on your next draw. Thank you for playing with Bitcoin the
                  online lottery.
                </p>

                <div className="thankurl right">
                  <Link href="/">
                    <span style={{ color: "#06a153", cursor: "pointer" }}>
                      CONTINUE &gt;&gt;
                    </span>
                  </Link>
                </div>
